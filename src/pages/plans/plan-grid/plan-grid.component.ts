...
@Component({
  ...
  template: `
    <div class="space-y-6 pb-16">
      ...
      <!-- ========================================================================= -->
      <!-- 2. LEARNING PLAN OPERATIONAL CAPACITY SNAPSHOT BANNER                      -->
      <!-- ========================================================================= -->
      <div class="bg-base-100 rounded-2xl border border-base-300 p-5 shadow-xs relative overflow-hidden">
        <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-3 pb-3 border-b border-base-300">
          <div class="flex items-center gap-2.5">
            <div class="w-8 h-8 rounded-lg bg-tenant-50 dark:bg-tenant-950/60 border border-tenant-200 dark:border-tenant-800 flex items-center justify-center text-tenant-600 dark:text-tenant-300">
              <span class="material-symbols-outlined text-lg">assignment</span>
            </div>
            <div>
              <h2 class="text-xs font-bold text-text-primary">
                Learning Plan Operational Overview
              </h2>
              <span class="text-[11px] text-text-secondary">
                Structured curricula and roadmap execution for {{ activeLms().basicInfo.lmsName }}
              </span>
            </div>
          </div>

          <div class="flex items-center gap-2 text-xs">
            <span class="px-2.5 py-1 rounded-lg bg-base-200 border border-base-300 font-mono text-[11px] font-semibold text-text-secondary">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 pt-3">
          <!-- Active Plans -->
          <div class="p-3 rounded-xl bg-emerald-50/50 dark:bg-emerald-950/20 border border-emerald-200/60 dark:border-emerald-900/40 flex items-center justify-between">
            <div>
              <span class="text-[11px] font-medium text-emerald-800 dark:text-emerald-300 block">Active Plans</span>
              <span class="text-xs text-emerald-700/80 dark:text-emerald-400">Currently in execution</span>
            </div>
            <div class="text-lg font-black font-mono text-emerald-700 dark:text-emerald-300">
              {{ planStats().activeCount }}
            </div>
          </div>

          <!-- Published Plans -->
          <div class="p-3 rounded-xl bg-sky-50/50 dark:bg-sky-950/20 border border-sky-200/60 dark:border-sky-900/40 flex items-center justify-between">
            <div>
              <span class="text-[11px] font-medium text-sky-800 dark:text-sky-300 block">Published</span>
              <span class="text-xs text-sky-700/80 dark:text-sky-400">Open for enrollment</span>
            </div>
            <div class="text-lg font-black font-mono text-sky-700 dark:text-sky-300">
              {{ planStats().publishedCount }}
            </div>
          </div>

          <!-- In Draft Plans -->
          <div class="p-3 rounded-xl bg-amber-50/50 dark:bg-amber-950/20 border border-amber-200/60 dark:border-amber-900/40 flex items-center justify-between">
            <div>
              <span class="text-[11px] font-medium text-amber-800 dark:text-amber-300 block">In Draft</span>
              <span class="text-xs text-amber-700/80 dark:text-amber-400">Under development</span>
            </div>
            <div class="text-lg font-black font-mono text-amber-700 dark:text-amber-300">
              {{ planStats().draftCount }}
            </div>
          </div>

          <!-- Curriculum Phases -->
          <div class="p-3 rounded-xl bg-purple-50/50 dark:bg-purple-950/20 border border-purple-200/60 dark:border-purple-900/40 flex items-center justify-between">
            <div>
              <span class="text-[11px] font-medium text-purple-800 dark:text-purple-300 block">Curriculum Phases</span>
              <span class="text-xs text-purple-700/80 dark:text-purple-400">Total roadmap steps</span>
            </div>
            <div class="text-lg font-black font-mono text-purple-700 dark:text-purple-300">
              {{ planStats().totalPhases }}
            </div>
          </div>
        </div>
      </div>
